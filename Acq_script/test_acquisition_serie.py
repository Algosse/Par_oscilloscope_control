...
def run(window):
    parameters = {}
    dic.load_dico('Acq_script/test_acquisition_serie.dat', parameters)
...
# =============================================================================
    ...
    np.random.seed(1)
    Nb_cle=parameters['nb_plain']
    Liste_cle=[]
    for k in range(Nb_cle):
        cle = ""
        for l in range(16):
            cle+=chr(np.random.randint(0,255))
